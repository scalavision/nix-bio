/**
Script taken from the Matthew Bauer's excellent blog post on how
to extract all available version of a tool residing in all the
different versions of nix channels.

https://matthewbauer.us/blog/all-the-versions.html
*/

{ channels ? [ "20.03" "19.09" "19.03" "18.09" "18.03" "17.09" "17.03"
